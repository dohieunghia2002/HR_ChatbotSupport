...
export default function Home() {
  ...
  // Chuẩn hóa nguồn tài liệu một cách an toàn với type
      ...
      .map((item): Source | null => {
        ...
        if (item && typeof item === "object") {
          ...
          const file =
            ...
            ((obj.metadata as Record<string, unknown> | undefined)?.source as string | undefined) ??
            ((obj.metadata as Record<string, unknown> | undefined)?.file as string | undefined) ??
            "unknown";

          const pageRaw =
            obj.page ??
            obj.page_number ??
            ((obj.metadata as Record<string, unknown> | undefined)?.page as unknown);

          const page = pageRaw != null ? String(pageRaw) : "N/A";
      ...
      <div className="border-t border-gray-200 bg-white px-4 py-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex gap-3 items-end">
            <textarea
              className="flex-1 resize-none border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[56px] max-h-32 text-gray-900 placeholder-gray-500"
